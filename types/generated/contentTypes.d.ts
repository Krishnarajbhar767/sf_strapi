...
export interface ApiGridSection2GridSection2 extends Struct.SingleTypeSchema {
  collectionName: 'grid_section_2s';
  info: {
    displayName: 'grid-section-2';
    pluralName: 'grid-section-2s';
    singularName: 'grid-section-2';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::grid-section-2.grid-section-2'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVideoSection3VideoSection3 extends Struct.SingleTypeSchema {
  collectionName: 'video_section_3s';
  info: {
    displayName: 'video-section-3';
    pluralName: 'video-section-3s';
    singularName: 'video-section-3';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::video-section-3.video-section-3'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subHeading: Schema.Attribute.String & Schema.Attribute.Required;
